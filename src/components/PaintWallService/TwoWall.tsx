...
type TwoWallNavigationProp = StackNavigationProp<RootStackParamList, 'ShippingDetails'>;
...
const TwoWall = ({ closeModal }: { closeModal: () => void }) => {
  ...
  const products: Product[] = [
    { title: 'Two Walls Tractor Emulsion Double Coat Without Primer', originalCost: 4700, newCost: 3186 },
    { title: 'Two Walls Tractor Emulsion Double Coat With Primer', originalCost: 5168, newCost: 3503 },
    { title: 'Two Walls Premium Emulsion Double Coat Without Primer', originalCost: 5755, newCost: 3902 },
    { title: 'Two Walls Premium Emulsion Double Coat With Primer', originalCost: 5286, newCost: 3583 },
  ];
