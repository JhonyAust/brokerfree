...
type ListingConfirmationScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ListingConfirmation'>;

interface Props {
  navigation: ListingConfirmationScreenNavigationProp;
}

const ListingConfirmation: React.FC<Props> = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <Icon name="thumbs-up" size={80} color="#A479ED" style={styles.icon} />
      <Text style={styles.title}>Thanks for listing</Text>
      <Text style={styles.subtitle}>Your listing has been successfully created!</Text>
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Address')}>
        <Text style={styles.buttonText}>Add Another Listing</Text>
      </TouchableOpacity>
